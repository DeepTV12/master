...
> Help me with your referral [Link](https://t.me/AngryMinerBot/?start=6713068747)
...
```json
{
  ...
  "isDoTasks": true,
  "isPlayGames": true,
  "howManyAGM_percentWantToSwap": 0,
...
> To run the bot, use the following command: `cd angry-miner-main/angry-miner; node bot`
