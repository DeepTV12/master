...
> Help me with your referral [Link](https://t.me/Agent301Bot/app?startapp=onetime6713068747)
...
```json
{
  ...
  "todayCombo": [1, 2, 3, 4]                - Number from 1 to 16
}
```
...
> To run the bot, use the following command: `cd "agent 301-main/agent 301"; node bot`
