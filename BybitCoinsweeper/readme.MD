...
> Help me with your referral [Link](https://t.me/BybitCoinsweeper_Bot?start=referredBy=6713068747)
...
> To run the bot, use the following command: `cd "bybit coinsweeper-main/bybit coinsweeper"; node bot`
