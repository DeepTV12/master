...
> > > Help me with your referral [Link](https://t.me/BitsTonboxBot/BitsAirdrops?startapp=DpaBU4CMgxkN6jis1CdESg)
...
### 5. `answers.txt` 🕒 - Fill the daily code, each row is one anwser, bot will filter and choose the correct one for each quest.
