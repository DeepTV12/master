...
### 1. `configs.json` 📜 - Adjust configuration - Game cannot started yet, i will update in the future
...
> To run the bot, use the following command: `cd "pocket rocket-main/pocket rocket"; node 1`
